                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="service_name" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="inputEmail3" name="service_cost" value="" min="10">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="service_description" value="">
                                    </div>
                                </div>

                                <input type="submit" class="btn btn-primary" name="registerdestination" value="Save Data">
                            ...
                            if (isset($_POST['registerdestination'])) {
                                ...
                                if (empty($service_description) || empty($service_cost) || empty($service_name)) {
                                    ...
                                    $insert = "INSERT INTO `services`(`service_name`, `service_cost_description`, `service_desc`)  
                                VALUES('$service_name', '$service_cost', '$service_description')";
