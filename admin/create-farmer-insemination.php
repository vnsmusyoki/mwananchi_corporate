...
<head>
    ...
    <title>Creating Farmer Insemination Requests</title>
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            if (isset($_POST['register_btn'])) {
                                ...
                                if (empty($farmid) || empty($date) || empty($details) || empty($officerid)) {
                                    ...
                                    $insert_location = "INSERT INTO artificial_insemination (artificial_insemination_officer_id, artificial_insemination_location_id, artificial_insemination_date,artificial_insemination_details)
                                                            VALUES ('$officerid','$farmid', '$date', '$details')";
