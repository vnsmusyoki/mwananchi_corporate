                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            if (isset($_POST['register_btn'])) {
                                ...
                                if (empty($farmer_id) || empty($farm_latitude) || empty($farm_longitude)) {
                                    ...
                                    if ($num_rows < 1) {
                                        ...
                                        $insert_location = "INSERT INTO farmer_locations (farmer_locations_farmer_id, farmer_locations_latitude, farmer_locations_longitude)
                                                            VALUES ('$farmer_id', '$farm_latitude', '$farm_longitude')";
                                        ...
                                        if ($query_insert_location) {
                                            ...
                                            echo "<script>alert('Farm location marked successfully');</script>";
                                            echo "<script>window.location.replace('all-locations.php');</script>";
                                        } else {
                                            $msg = "Failed to insert farm location";
                                        }
                                    }
                                }
                            }
                            ...
                            <form action="" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="farm_latitude" value="<?php echo isset($_POST['farm_latitude']) ? htmlspecialchars($_POST['farm_latitude']) : ''; ?>" class="form-control">

                                </div>
                                <div class="form-group">
                                    <label>Farm Longitude</label>
                                    <input type="text" name="farm_longitude" value="<?php echo isset($_POST['farm_longitude']) ? htmlspecialchars($_POST['farm_longitude']) : ''; ?>" class="form-control">
