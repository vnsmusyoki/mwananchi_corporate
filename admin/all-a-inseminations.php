...
<body id="page-top">
    ...
    <tr>
        ...
        <td><a href='edit_farm_location.php?id=$id' class='btn btn-primary btn-block'>Edit</td>
        <td><a href='delete_farm_location.php?id=$id' class='btn btn-danger btn-block'>Delete</td>
    </tr>
    ";
                                        }
