                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            if (isset($_POST['register_btn'])) {
                                ...
                                if (empty($farmid) || empty($date) || empty($details) || empty($officerid)) {
                                    ...
                                    $insert_location = "UPDATE  vaccination  SET vaccination_officer_id='$officerid', vaccination_location_id='$farmid', vaccination_date='$date',vaccination_details='$details' WHERE vaccination_id='$insid'";
                                    ...
                                    if ($query_insert_location) {
                                        ...
                                        echo "<script>alert('Vaccination schedule updated successfully');</script>";
                                        echo "<script>window.location.replace('all-vaccinations.php');</script>";
                                    } else {
                                        $msg = "Failed to schedule vaccination details";
                                    }
                                }
                            }
                            ...
                            <form action="" method="POST" autocomplete="off">
                                <center><span>Edit Scheduled Vaccination Details </span></center>
                                <hr>
                                <?php
