                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            if (isset($_POST['register_btn'])) {
                                ...
                                if (empty($farmid) || empty($message)) {
                                    $msg = "Provide all the details";
                                } else {

                                    // Insert data into farmer_locations table
                                    $insert_location = "INSERT INTO communication (communication_sender_id, communication_receiver_id, communication_receiver_content,communication_status) VALUES ('$memberid','$farmid', '$message', 'unread')";
                            ...
                            <form action="" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="message_content" value="<?php echo isset($_POST['message_content']) ? htmlspecialchars($_POST['insemination_details']) : ''; ?>" class="form-control">



                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-block btn-primary" name="register_btn">Send Message </button>
                                </div>
