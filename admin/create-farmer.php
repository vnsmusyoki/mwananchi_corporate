                        ...
                        <div class="col-lg-10 col-md-10 col-xs-12 col-sm-12" style="background-color: white;padding:20px;">
                            ...
                            <form action="" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="farmer_location" value="<?php echo isset($_POST['farmer_location']) ? htmlspecialchars($_POST['farmer_location']) : ''; ?>" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-block btn-primary" name="register_btn">Register Farmer</button>
                                    </div>
