...
<head>
    ...
    <title>All Veterinary Officers</title>
...
<body id="page-top">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between">
                                <h2 class="title-1 m-b-25">All Veterinary Officers</h2>
                                <a href="create-veterinary-officer.php" class="btn btn-primary">Register New Officer</a>
                            </div>
                            ...
                            <div class="table-responsive table--no-card m-b-40" style="background-color: #fff;padding:1rem .4rem;">
                                <table class="table table-bordered" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        $data = "SELECT veterinary_officers.*, login.login_username 
         FROM `veterinary_officers` 
         LEFT JOIN `login` ON veterinary_officers.veterinary_officers_id = login.login_officer_id";
                                        $query = mysqli_query($conn, $data);

                                        while ($fetch = mysqli_fetch_assoc($query)) {
                                            $id = $fetch['veterinary_officers_id'];
                                            $farmername = $fetch['veterinary_officers_officer_name'];
                                            $location = $fetch['veterinary_officers_address'];
                                            $email = $fetch['veterinary_officers_email_address'];
    ...
    <tr>
        ...
        <td>$location</td> 
        <td>$username</td> 
        <td><a href='edit_veterinary_officer.php?id=$id' class='btn btn-primary btn-block'>Edit</td>
        <td><a href='delete-veterinary-officer.php?id=$id' class='btn btn-danger btn-block'>Delete</td>
    </tr>
    ";
                                        }
