                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="create-customer.php" class="btn btn-primary">Register New Customer</a>
                                    ...
                                    <tbody>
                                       ...
                                       include 'db-connection.php';
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($query)) {
                                            ...
                                            $employeename = $fetch['customer_name'];
                                            $employee_email = $fetch['customer_email'];
                                            $employee_mobile = $fetch['customer_phone_no'];
