...
<head>
    ...
    <title>Laundry Admin - All Services</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-25">All Services</h2>
                            <a href="create-service.php" class="btn btn-primary">Register New Service</a>
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($query)) {
                                            ...
                                            echo "
                                                <tr>
                                                    ...
                                                    <td>KES $cost</td> 
                                                     <td>$desc</td>  
                                                    <td><a href='edit_service.php?id=$id' class='btn btn-primary btn-block'>edit</td>
                                                    <td><a href='delete-service.php?id=$id' class='btn btn-danger btn-block'>delete</td>
                                                </tr>
                                            ";
                                        }
