                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="week_day" id="" class="form-control">
                                            ...
                                            <option value="Monday" <?php if ($town == "Monday") {
                                                                        echo 'selected';
                                                                    } ?>>Monday</option>
                                            <option value="Tuesday" <?php if ($town == "Tuesday") {
                                                                        echo 'selected';
                                                                    } ?>>Tuesday</option>
                                            <option value="Wednesday" <?php if ($town == "Wednesday") {
                                                                            echo 'selected';
                                                                        } ?>>Wednesday</option>
                                            <option value="Thursday" <?php if ($town == "Thursday") {
                                                                            echo 'selected';
                                                                        } ?>>Thursday</option>
                                            <option value="Friday" <?php if ($town == "Friday") {
                                                                        echo 'selected';
                                                                    } ?>>Friday</option>
                                            <option value="Saturday" <?php if ($town == "Saturday") {
                                                                            echo ' selected';
                                                                        } ?>>Saturday</option>
                                            <option value="Sunday" <?php if ($town == "Sunday") {
                                                                        echo 'selected';
                                                                    } ?>>Sunday</option>
                                        </select>
                                    </div>
