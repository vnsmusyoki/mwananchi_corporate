                                    ...
                                    <tbody>
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($query)) {
                                            ...
                                            while ($queryfetch = mysqli_fetch_assoc($querypay)) {
                                                ...
                                                <td><a href='edit-order.php?id=$orderid' class='btn btn-primary btn-block'>edit</td>
                                                <td><a href='delete-order.php?id=$orderid' class='btn btn-danger btn-block'>delete</td>
                                            </tr>
                                                ";
                                            }
                                        }
